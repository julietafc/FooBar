    ...
    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 151.49 250">
      <defs>
        <linearGradient id="linear-gradient" x1="1.95" y1="122.39" x2="151.04" y2="122.39" gradientUnits="userSpaceOnUse">
          <stop offset="0.01" stop-color="#9e005d" />
          <stop offset="0.07" stop-color="#a90461" stop-opacity="0.97" />
          <stop offset="0.13" stop-color="#ca116d" stop-opacity="0.88" />
          <stop offset="0.17" stop-color="#ed1e79" stop-opacity="0.79" />
          <stop offset="0.23" stop-color="#d81671" stop-opacity="0.85" />
          <stop offset="0.36" stop-color="#b70966" stop-opacity="0.93" />
          <stop offset="0.55" stop-color="#a3025f" stop-opacity="0.99" />
          <stop offset="1" stop-color="#9e005d" />
        </linearGradient>
        <clipPath id="clip-path">
          <rect id="mask" class="cls-1" x="121.49" y="43.39" width="17" height="157" rx="8.5" />
        </clipPath>
        ...
        <clipPath id="clip-path-2">
          <rect class="cls-1" x="12.59" y="43.39" width="90" height="90" rx="11.71" />
        </clipPath>
        <linearGradient id="linear-gradient-3" x1="6.68" y1="88.39" x2="95.68" y2="88.39" gradientUnits="userSpaceOnUse">
          ...
          <stop offset="0.04" stop-color="#fff" stop-opacity="0.13" />
          <stop offset="0.07" stop-color="#fff" stop-opacity="0.29" />
          <stop offset="0.11" stop-color="#fff" stop-opacity="0.5" />
          <stop offset="0.15" stop-color="#fff" stop-opacity="0.77" />
          <stop offset="0.15" stop-color="#fff" stop-opacity="0.79" />
          <stop offset="0.16" stop-color="#fff" stop-opacity="0.77" />
          <stop offset="0.24" stop-color="#fff" stop-opacity="0.59" />
          <stop offset="0.32" stop-color="#fff" stop-opacity="0.43" />
          <stop offset="0.4" stop-color="#fff" stop-opacity="0.3" />
          <stop offset="0.49" stop-color="#fff" stop-opacity="0.19" />
          <stop offset="0.59" stop-color="#fff" stop-opacity="0.11" />
        ...
        <linearGradient id="linear-gradient-4" x1="76.58" y1="14.64" x2="94.58" y2="14.64" gradientUnits="userSpaceOnUse">
          <stop offset="0.3" stop-color="#7f2121" />
          <stop offset="0.37" stop-color="#7f2121" stop-opacity="0.93" />
          <stop offset="1" stop-color="#7f2121" stop-opacity="0" />
        </linearGradient>
        <linearGradient id="linear-gradient-5" x1="76.08" y1="28.89" x2="95.08" y2="28.89" gradientUnits="userSpaceOnUse">
          ...
          <stop offset="0.34" stop-color="#ccc" />
        ...
        <linearGradient id="linear-gradient-6" x1="30.58" y1="14.64" x2="48.58" y2="14.64" gradientUnits="userSpaceOnUse">
          <stop offset="0.3" stop-color="#105b30" />
          <stop offset="0.37" stop-color="#105b30" stop-opacity="0.93" />
          <stop offset="1" stop-color="#105b30" stop-opacity="0" />
        </linearGradient>
      ...
      <g className="box-container" transform="translate(0 35)">
        ...
        <g id="pipet">
          <g id="level-mask">
            <g class="cls-8">
              <g id="level" transform={"translate(0 " + level + ")"}>
                <g id="scum">
                  <path class="cls-9" d="M135.82,60H124.53a2.67,2.67,0,0,1-2.67-2.67V54.58a8.19,8.19,0,0,1,8.19-8.19h.25a8.19,8.19,0,0,1,8.19,8.19V57.3A2.66,2.66,0,0,1,135.82,60Z" />
                </g>
                <g id="liquid">
                  <rect class="cls-10" x="121.86" y="49.3" width="16.63" height="151.09" rx="7.99" />
                </g>
              </g>
            </g>
          </g>
          <g id="glass">
            ...
            <path className="cls-12" d="M130,44.44a10.46,10.46,0,0,1,10.46,10.45v137a10.46,10.46,0,0,1-20.91,0v-137A10.46,10.46,0,0,1,130,44.44m0-1a11.5,11.5,0,0,0-11.5,11.5v137a11.5,11.5,0,1,0,23,0v-137A11.5,11.5,0,0,0,130,43.39Z" />
          </g>
        </g>
        <g id="pic-holder">
          <g id="pic-mask">
