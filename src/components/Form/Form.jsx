...
export default function Form(props) {
  ...
  if (props.isMobile) {
    ...
    return (
      <div className="Layout">
        <ProductList addToBasket={addToBasket} beers={beers} />
        <Basket style={props.cart && style} resetBasket={resetBasket} deleteBeer={deleteBeer} decreaseAmount={decreaseAmount} increaseAmount={increaseAmount} addMoreBeer={addMoreBeer} basket={basket} addID={addID} />
      </div>
    );
  }
}
