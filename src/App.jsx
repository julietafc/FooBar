    ...
    <div className="App">
      ...
      <main>
        <Routes>
          ...
          <Route exact path="/Form" element={<Form products={products} cart={cart} isMobile={isMobile} ordersReady={ordersReady} isHappyHour={isHappyHour} cart={cart} setCart={setCart} />} />
        </Routes>
      </main>
      <Footer />
    </div>
